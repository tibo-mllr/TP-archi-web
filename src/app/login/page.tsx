...
export default function LoginPage() {
    ...
    return <>
        ...
        <form className="flex flex-col gap-4" onSubmit={onSubmit} >
            <input name="username" type="text" placeholder="Username" className="bg-gray-500 border-black-700"/>
            <input name="password" type="password" placeholder="Password" className="bg-gray-500 border-black-700"/>
